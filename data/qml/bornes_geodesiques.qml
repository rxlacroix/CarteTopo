...
<qgis readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="0" version="3.4.6-Madeira" simplifyDrawingTol="1" simplifyLocal="1" styleCategories="AllStyleCategories" minScale="1e+8" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="2" field="man_made" name=""/>
    <alias index="3" field="source" name=""/>
    <alias index="4" field="description" name=""/>
    <alias index="5" field="ele" name=""/>
    <alias index="6" field="note" name=""/>
    <alias index="7" field="ref" name=""/>
    <alias index="8" field="url" name=""/>
    <alias index="9" field="name" name=""/>
    <alias index="10" field="natural" name=""/>
    <alias index="11" field="historic" name=""/>
  </aliases>
